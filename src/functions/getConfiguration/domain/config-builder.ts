...
export const buildConfig = async (staffNumber: string, examinerRole: ExaminerRole): Promise<RemoteConfig> => {
...
const addTestPermissionPeriods = async (builtConfig: RemoteConfig, staffNumber: string): Promise<RemoteConfig> => {
  try {
